...
//        driver.findElement(By.xpath("//button[normalize-space()='Login']")).click();
 ...
 private  String findEmployeeStatus(String employeeName) {
     ...
     String firstpart = "//div[@role='table']";
     String scondpart = "/div[2]";
     String thirdpart = "]";
     String employeeStatus = null;

//div[@role='table']/div[2]/div[1]/div/div[9]/div/button
     for (int i = 1; i <= row; i++) {
         for (int j = 0; j <= col; j++) {

             String dynamicPath = firstpart + i + scondpart + j + thirdpart;
